...
export const abrirSesionMesa = (id) => api.post(`/mesas/${id}/sesion`).then(r => r.data.datos);
export const cerrarSesionMesa = (id) => api.delete(`/mesas/${id}/sesion`).then(r => r.data.datos);
